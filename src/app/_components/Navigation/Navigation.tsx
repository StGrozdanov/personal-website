    ...
    <nav className='flex justify-between items-center py-4 px-4 lg:px-28 text-gray-500 font-medium font-inter dark:bg-black dark:text-gray-400'>
      <Link href='/'>
        <Image
          ...
          width={70}
          height={70}
          className='filter grayscale brightness-70 cursor-pointer hover:scale-105 hover:brightness-50 hover:rotate-16 transition-transform duration-600 dark:brightness-110 dark:hover:brightness-150'
        />
      </Link>
